...
<body>
    ...
    <div>
        <h2 class="text-tengah"><b>LAPORAN SURAT KETERANGAN TIDAK MAMPU</b></h2>
    </div>
        ...
        <table style="width: 100%;border-collapse: collapse;">
            ...
            <?php foreach ($data as $value) { ?>
                <tr>
                    ...
                    <td class="text-tengah"><?php echo $value->id_sktm; ?></td>
                    <td class="text-tengah"><?php echo $value->nomor_surat; ?></td>
