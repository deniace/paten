        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tambah Registrasi Surat Masuk</h1>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                <div class="float-left font-weight-bold text-primary">Tambah Registrasi surat masuk</div>
                            </div>
                            <div class="card-body">

                                <?php echo $this->session->flashdata('message'); ?>

                                <form method="post" action="<?php echo base_url('surat_masuk/tambah'); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php echo form_error('asal_surat') ? 'is-invalid' : '' ?>" name="asal_surat" id="asal_surat" placeholder="Asal Surat" required>
                                        <div class="invalid-feedback"><?php echo form_error('asal_surat'); ?></div>
                                    </div>

                                    <div class="form-group">
                                        <label for="tgl_terima">Tanggal Terima</label>
                                        <input type="text" class="form-control <?php echo form_error('tgl_terima') ? 'is-invalid' : '' ?>" name="tgl_terima" id="tgl_terima" placeholder="tgl terima" required>
